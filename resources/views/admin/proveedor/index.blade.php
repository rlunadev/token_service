...
<div class="panel panel-default">
	<div class="col-md-12" style="background-color:#f5f5f5">
		...
		<div class="col-md-4">
		{!!Form::open(['route'=>'admin.proveedor.index','method'=>'GET','class'=>'navbar-form pull-right'])!!}
		...
		<div class="panel-footer" >
				...
				<div class="col-md-6 text-right">
					<a href="{{route('admin.proveedor.create')}}" class="text-right"><button class="btn btn-primary"> <span class="glyphicon glyphicon-plus"></span>Agregar</button></a>
				</div>
			<br><br>
		</div>
</div>
