...
function getAll(){
	$.ajax({
		type: 'GET',
		url:{!!json_encode(url('/'))!!}+"/api/categoria/GetAll?token="+localStorage.getItem('token'),
...
function deleteById (id){
	$.ajax({
		type: 'POST',
		url:{!!json_encode(url('/'))!!}+"/api/categoria/DeleteById?token="+localStorage.getItem('token'),
    data:{
      id:id
    },
		success: function(result) {
...
function GetById (id){
	$.ajax({
		type: 'POST',
		url:{!!json_encode(url('/'))!!}+"/api/categoria/GetById?token="+localStorage.getItem('token'),
    data:{
      id:id
    },
		success: function(result) {
...
function update (nombre,descripcion){
	$.ajax({
		type: 'POST',
		url:{!!json_encode(url('/'))!!}+"/api/categoria/Update?token="+localStorage.getItem('token'),
    data:{
      id:auxId,
      nombre:nombre,
      descripcion:descripcion
